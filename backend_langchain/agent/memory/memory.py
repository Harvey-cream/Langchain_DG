...
from agent.memory.memory_persist import MemoryTurnContext, schedule_async_summary_persist
from agent.memory.token_budget import estimate_messages_tokens
...
async def maybe_compress_history(
    ...
    *,
    ...
    from agent.memory.memory_summary import (
        build_summary_system_message,
        extract_summary_text,
        summarize_overflow,
    )
    from agent.memory.memory_trim import (
        is_memory_summary,
