...
from User.models import UserConversation, UserSession, InterviewConversation, InterviewSession
...
# ---------------------------------------------------------------------------
# AI 面试大师（独立表 interview_conversations / interview_sessions，与上方超级智能体隔离）
# ---------------------------------------------------------------------------
