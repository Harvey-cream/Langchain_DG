...
PROD_IMPORTS: list[tuple[str, str]] = [
    ...
    ("runtime.execution.graph_factory", "LangGraph 图工厂"),
    ("runtime.streaming.stream", "LangGraph 事件流"),
    ("runtime.context.builder", "Context Builder"),
    ("runtime.checkpoint.checkpointer", "PG checkpoint"),
    ("app.sse", "SSE 流式"),
    ("infrastructure.rag.rag", "pgvector RAG"),
    ("infrastructure.rag.embedding", "DashScope 嵌入"),
    ("infrastructure.rag.skill_router", "Skill 路由引擎"),
    ("infrastructure.rag.retrieval_planner", "检索规划器"),
    ("infrastructure.rag.rerank", "DashScope 精排"),
    ("products.interview.runtime", "面试 Agent 运行时"),
    ("products.interview.skills", "面试 Skill 目录"),
    ("products.interview.tools", "面试工具装配"),
    ("infrastructure.pdf.schema_tools", "内置工具 schema"),
    ("infrastructure.pdf.human_loop", "PDF interrupt 解析"),
    ("infrastructure.pdf.pdf_export_render", "PDF 渲染"),
    ("infrastructure.mcp.mcp_multiserver", "MCP 客户端"),
    ("infrastructure.memory.agent", "Memory Agent（异步）"),
